...
enum class CategoryScreenMode { HIDE_OVERLAY, SHOW_ERROR, SHOW_CREATE_CATEGORY }
...
data class CategoriesScreenState(
    ...
    fun showCreateCategory(): CategoriesScreenState {
        return this.copy(screenMode = CategoryScreenMode.SHOW_CREATE_CATEGORY, isOverlayShown = true)
    }
