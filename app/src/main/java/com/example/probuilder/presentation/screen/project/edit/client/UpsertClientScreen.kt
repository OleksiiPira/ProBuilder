...
fun UpsertClientScreen(
    ...
    Scaffold(
        ...
        EditClientScreenContent(modifier.padding(paddings), scrollState, client, viewModel::onEvent, viewModel::saveProject, goBack)
    }
}

@Composable
private fun EditClientScreenContent(
    modifier: Modifier,
